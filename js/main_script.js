...
$(function() {
	$('.slider_tab_box').on('click', '.slider_tab:not(.active_sl_tab)', function() {
		...
		$(this).closest('#rec106999988, #rec113765040').find('.tn-atom__img').css({"opacity" : "0", "height" : "0"}).eq($(this).index()).css({"opacity" : "1", "height" : "auto"});
		$(this).closest('#rec106999988, #rec113765040').find('.tn-atom__pin').css("opacity", 0).eq($(this).index()).css("opacity", 1);
